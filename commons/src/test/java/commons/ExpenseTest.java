...
public class ExpenseTest {
    ...
    void setUp() {
        ...
        tag = new Tag("test", Color.green);
        
        expense = new Expense("Expense", 50.0, payee, payors, tag);
    }
    ...
    void testSettleDebts() {
        ...
        payors.add(payor1);
        payors.add(payor2);
        Tag tag = new Tag("test", Color.yellow);
        // Create an expense with a payee and payors
        Expense expense = new Expense("Expense", 50.0, payee, payors,tag);
    ...
    @Test
    void testEquals() {
        Expense sameExpense = new Expense("Expense", 50.0, payee, payors, tag);
        assertEquals(expense, sameExpense);
    }

    @Test
    void testNotEquals() {
        Expense differentExpense = new Expense("Different Expense", 50.0, payee, payors, tag);
    ...
    public void testNegativeAmountConstructor() {
        assertThrows(IllegalArgumentException.class, () -> new Expense("Negative Expense", -50.0,  payee, payors, tag));
    }
